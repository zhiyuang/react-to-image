...
const clipBorderTop = (ctx: CanvasRenderingContext2D, layout, style, rtr, rtl) => {
...
const fillBorderTop = (ctx: CanvasRenderingContext2D, layout, style, rtr, rtl) => {
...
const clipBorderRight = (ctx: CanvasRenderingContext2D, layout, style, rtr, rbr) => {
  const { top, left, width, height } = layout;
...
const fillBorderRight = (ctx: CanvasRenderingContext2D, layout, style, rtr, rbr) => {
  const { top, left, width, height } = layout;
  const {
    borderRightColor,
    borderRightStyle,
...
const clipBorderBottom = (ctx: CanvasRenderingContext2D, layout, style, rbl, rbr) => {
  const { top, left, width, height } = layout;
...
const fillBorderBottom = (ctx: CanvasRenderingContext2D, layout, style, rbl, rbr) => {
  const { top, left, width, height } = layout;
  const {
    borderBottomColor,
    borderBottomStyle,
...
const clipBorderLeft = (ctx: CanvasRenderingContext2D, layout, style, rbl, rtl) => {
  const { top, left, width, height } = layout;
...
const fillBorderLeft = (ctx: CanvasRenderingContext2D, layout, style, rbl, rtl) => {
...
const renderBorders = (ctx: CanvasRenderingContext2D, node) => {
